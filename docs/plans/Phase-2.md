...
**This phase assumes Unity 6.0 upgrade is complete.** All character systems (CharacterCombat, CharacterMovement) use Unity 6 APIs. Physics behavior and force tuning are based on Unity 6 physics engine. See `UNITY_6_UPGRADE_IMPACT.md` for details.
